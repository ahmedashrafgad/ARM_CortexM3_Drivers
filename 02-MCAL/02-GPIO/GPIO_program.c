...
void MGPIO_voidSetPinDirection(u8 Copy_u8PortID,u8 Copy_u8PinID,u8 Copy_u8Mode)
{
 ...
 void MGPIO_voidSetPortValue   ( u8 Copy_u8PortID , u32 Copy_u32Value )
 {
 	switch (Copy_u8PortID)
 	{
 		case GPIO_PORTA : GPIOA_ODR =  Copy_u32Value ; break ;
 		case GPIO_PORTB : GPIOB_ODR =  Copy_u32Value ; break ;
 		case GPIO_PORTC : GPIOC_ODR =  Copy_u32Value ; break ;
 ...
 void MGPIO_voidSetPortDirection  ( u8 Copy_u8PortID , u32 Copy_u32PortMode  )
 {
	 switch(Copy_u8PortID){
	 	case GPIO_PORTA:
	 		GPIOA_CRL = Copy_u32PortMode ;
	 		GPIOA_CRH = Copy_u32PortMode ;
	 		break;

	 	case GPIO_PORTB:
	 		GPIOB_CRL = Copy_u32PortMode ;
	 		GPIOB_CRH = Copy_u32PortMode ;
	 		break;
	 	case GPIO_PORTC:
	 		GPIOC_CRL = Copy_u32PortMode ;
	 		GPIOC_CRH = Copy_u32PortMode ;
	 		break;
